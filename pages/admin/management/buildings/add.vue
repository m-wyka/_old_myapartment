...
const dottedLineVerticalClass =
  "w-px absolute -left-[9px] top-[-88px] h-[calc(100%+88px+16px)]";
const dottedLineHorizontalClass = "absolute -top-[9px] left-0 right-0 h-px";
</script>
...
<template>
  ...
  >
    ...
    <DottedLine
      ...
      :class="dottedLineHorizontalClass"
    />
